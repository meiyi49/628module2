...
confit(forward_model_ols)
```

```{r}
freq <- popu/sum(popu)
png('density_plot.png',width=1000,height=700)
barplot(freq,col = 'lightblue',names.arg = c('[20-25)','[25,30)','[30,35)','[35,40)','[40-45)','[45,50)','[50,55)','[55,60)','[60,65)','[65,70)','[70,75)','[75,80)','[80,85)'),xlab = 'AGE',ylab = 'Freq')
dev.off()
```
